...
1. Clone the repository:
   ```
   git clone https://github.com/LokeshwarMenati/portfolio-frontend.git
   ```
...
- Email: [lokeshwarmenati@gmail.com](mailto:lokeshwarmenati@gmail.com)
- LinkedIn: Lokeshwar Menati
